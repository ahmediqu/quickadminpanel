...
use Auth;
class SectionVoicController extends Controller
{
    /**
    ...
    {
        $data = [];
        $data['section'] = SectionVoic::first();
        return view('backend.sections.sectionvoice.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if(isset($update_id) && !empty($update_id)){
            $aboutus =  SectionVoic::findOrFail($update_id);
        }else{
            $aboutus = new SectionVoic();
        }
        ...
        if ($image) {
            ...
            $destination_path = 'uploads/sectionvoice/';
