...
class SectionTwoController extends Controller
{
    ...
    {
        $data = [];
        $data['section'] = SectionTwo::first();
        return view('backend.sections.sectiontwo.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if(isset($update_id) && !empty($update_id)){
            $aboutus =  SectionTwo::findOrFail($update_id);
        }else{
            $aboutus = new SectionTwo();
        }
        ...
        if ($image) {
            ...
            $destination_path = 'uploads/sectiontwo/';
