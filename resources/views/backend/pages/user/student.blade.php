                            ...
                            <table id="tech-companies-1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/show-student',$user->id)}}" class="btn btn-outline-info"><i class="zmdi zmdi-eye"></i></a>
                                            <a href="{{url('admin/delete-users-student',$user->id)}}" onClick="return deleteconfirm();" class="btn btn-outline-danger"><i class="zmdi zmdi-delete"></i></a>
