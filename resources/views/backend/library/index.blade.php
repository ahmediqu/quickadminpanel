                    ...
                    <div class="card">
                        <div class="card-body">
                          @include('backend.partials._message')
                            <a href="{{route('library.create')}}" class="btn btn-success">Create a new Library</a> <br> <br>
                               ...
                               <tbody>
                                ...
                                <?php $blog1++; ?>
                                   <tr>
                                       ...
                                       <td>
                                         <?php
                                          if(isset($data->category_id) && !empty($data->category_id)){
                                            $category = DB::table('library_categories')->where('id',$data->category_id)->first();
                                       ...
                                       <td>
                                         <a href="{{route('library.edit',$data->id)}}" class="btn btn-info">Edit</a>
