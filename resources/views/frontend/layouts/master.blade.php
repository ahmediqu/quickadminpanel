        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav mr-auto custom-mr">
              ...
              <div aria-labelledby="megamneu" class="dropdown-menu border-0 p-0 m-0 show">
                <div class="container">
                  <div class="row bg-white rounded-0 m-0 shadow-sm">
                    <div class="col-lg-7 col-xl-8">
                      <div class="p-4">
                        <div class="row">
                          <div class="col-lg-6 mb-4">
                            <h6 class="font-weight-bold text-uppercase">Community</h6>
                            <ul class="list-unstyled">
                              ...
                              ?>
                              <li class="nav-item"><a href="{{url('community',$ct->id)}}" class="nav-link text-small font-weight-regular pb-0">{{$ct->category_name}}</a></li>
                             <?php } }?>
                              
                            </ul>
                          </div>
                          <div class="col-lg-6 mb-4">
                            <h6 class="font-weight-bold text-uppercase">Content</h6>
                            <ul class="list-unstyled">

                              <li class="nav-item"><a href="{{url('news')}}" class="nav-link text-small pb-0 font-weight-regular">News</a></li>
                      ...
                      <div class="col-lg-5 col-xl-4 px-0 d-none d-lg-block" style="background: center center url({{url('frontend/image/azamat-zhanisov-1308034-unsplash.jpg')}})no-repeat; background-size: contain;height: 278px;width: 100%;margin: 0;padding: 0;"></div>
                    </div>
                  </div>
                </div>
            </li>
